final: prev: let
  ...
  github-tags = ["nicobailon/pi-mcp-adapter" "2.34.0"]; # extractVersion=^v(?<version>.*)$
  hash-src = "sha256-YpiJROIG0/U81wAoImjktbg/d5wGnc6o130IlOrTyEE=";
  hash-npm-deps = "sha256-NnRdqv6cezZ5nv8daje8eK/A5gJFA2F852BkU5cVTRc=";
